    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 8px 30px rgba(124,58,237,0.12), 0 2px 8px rgba(0,0,0,0.06)',
          maxWidth: '300px',
          width: '90vw',
          padding: '20px',
          zIndex: 60,
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontSize: '0.82rem', color: '#374151', fontWeight: 500 }}>Auto-save to the cloud</span>
          </div>
          {/* Multiple canvases */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontSize: '0.82rem', color: '#374151', fontWeight: 500 }}>Multiple canvases</span>
          </div>
          {/* Version history */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
            ...
            <span style={{ fontSize: '0.82rem', color: '#374151', fontWeight: 500 }}>Version history</span>
          </div>
        </div>
        ...
        <button
          ...
          onMouseEnter={e => {
            (e.target as HTMLButtonElement).style.borderColor = '#d8b4fe';
            (e.target as HTMLButtonElement).style.boxShadow = '0 2px 8px rgba(124,58,237,0.1)';
          }}
          onMouseLeave={e => {
