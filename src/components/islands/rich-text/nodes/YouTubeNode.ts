...
import { extractYouTubeVideoId } from '../utils/embedUrl';
    ...
    static importDOM(): DOMConversionMap | null {
        return {
            iframe: (domNode: Node) => {
                ...
                if (!element.hasAttribute('data-lexical-youtube')) {
                    return null;
                }
                return {
...
export function $createYouTubeNodeFromPayload(payload: YouTubePayload): YouTubeNode {
    return $createYouTubeNode(payload.videoId);
}
