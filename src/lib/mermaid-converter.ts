/**
 * ╔══════════════════════════════════════════════════════════════════════════════╗
 * ║                    🧜‍♀️ mermaid-converter.ts                                  ║
 * ║                    "The Mermaid to Excalidraw Bridge"                        ║
 * ╠══════════════════════════════════════════════════════════════════════════════╣
 * ║  🏷️ BADGES: ⚪ Utility | 🔄 Converter | 🧩 Integration                        ║
 * ╚══════════════════════════════════════════════════════════════════════════════╝
 * 
 * 👤 WHO AM I?
 * I convert Mermaid diagram syntax into native Excalidraw elements using the
 * official @excalidraw/mermaid-to-excalidraw package. This enables AI-generated
 * diagrams that are fully editable within the canvas.
 * 
 * 🎯 WHAT USER PROBLEM DO I SOLVE?
 * - AI can generate concise Mermaid syntax (token-efficient)
 * - Users get fully editable Excalidraw shapes (not static images)
 * - No ghost element complexity - native elements from the start
 * 
 ...
 *      │                                                                  │
 *      │   ┌─────────────┐      ┌──────────────┐      ┌─────────────┐   │
 *      │   │   AI Chat   │─────▶│      ME      │─────▶│ Excalidraw  │   │
 *      │   │  (Mermaid)  │      │ (Converter)  │      │  (Elements) │   │
 *      │   └─────────────┘      └──────────────┘      └─────────────┘   │
 *      │                                                                  │
 *      │   I CONVERT:                                                     │
 *      │   - flowchart TD/LR/RL/BT → Native flowchart shapes              │
 ...
 * 
 * 🚨 IF I BREAK:
 * - Symptoms: Mermaid diagrams don't convert, empty elements returned
 * - User Impact: AI-generated diagrams fail to appear on canvas
 * - Quick Fix: Check mermaid syntax is valid before converting
 * - Debug: Look for parse errors from mermaid-to-excalidraw package
 * 
 * 📦 FUNCTIONS:
 * ┌─────────────────────────┬──────────────────────────────────────────────────┐
 * │ convertMermaidToCanvas  │ Main conversion function                         │
 * │ isMermaidDiagram        │ Detect if text contains Mermaid syntax           │
 * │ extractMermaidCode      │ Extract Mermaid code blocks from AI response     │
 * └─────────────────────────┴──────────────────────────────────────────────────┘
 * 
